...
const validateInputs = () => {
    ...
    if(emailValue === '') {
        ...
        document.querySelector('.emailError').innerText = 'Please provide a proper email';
        result = false;
    } else {
    ...
    if(passwordValue === '') {
        ...
        document.querySelector('.passwordError').innerText = 'Password must be at least 5 character.';
        result = false;
    } else {
